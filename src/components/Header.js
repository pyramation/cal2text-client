...
export const Header = ({
    ...
    return (<Navbar>
        ...
        <NavbarGroup align={Alignment.RIGHT}>
            ...
            {signedIn ? (<>
                <Button className={Classes.MINIMAL} icon="calendar" text="Select Calendars" onClick={notFinishedChoosingCalendars} />
                <Button className={Classes.MINIMAL} text="Sign Out" icon="log-out" onClick={signOut} />
            </>)
                :
